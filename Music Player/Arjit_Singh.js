const songs = [
    {
        ...
        poster: `img/Arjit_Singh/1.jpg`
    },
    {
        id: "2",
        songName: `Tum Mile<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/2.jpg`
    },
    {
        id: "3",
        songName: `Ae Dil Hai Mushkil<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/3.jpg`
    },
    {
        id: "4",
        songName: `Chhod Diya<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/4.jpg`
    },
    {
        id: "5",
        songName: `Pehle Bhi Mai<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/5.jpg`
    },
    {
        id: "6",
        songName: `Satranga<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/6.jpg`
    },
    {
        id: "7",
        songName: `Arjit Singh Mashup<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/7.jpg`
    },
    {
        id: "8",
        songName: `Dhop Main<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/8.jpg`
    },
    {
        id: "9",
        songName: `Phir Mohabbat<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/9.jpg`
    },
    {
        id: "10",
        songName: `Phir Kabhi<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/10.jpg`
    },
    {
        id: "11",
        songName: `Tere Hawaale<br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: `img/Arjit_Singh/11.jpg`
    },
    {
        id: "12",
        songName: `2002<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/12.jpg`
    },
    {
        id: "13",
        songName: `Alram<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/13.jpg`
    },
    {
        id: "14",
        songName: `Birthday<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/14.jpg`
    },
    {
        id: "15",
        songName: `Ciao Adios<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/15.jpg`
    },
    {
        id: "16",
        songName: `Our Song<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/16.jpg`
    },
    {
        id: "17",
        songName: `Psycho<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/17.jpg`
    },
    {
        id: "18",
        songName: `E.V.O.L<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/18.jpg`
    },
    {
        id: "19",
        songName: `Obsession<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/19.jpg`
    },
    {
        id: "20",
        songName: `FRIENDS<br>
        <div class="subtitle">Anna Marie</div>`,
        poster: `img/Arjit_Singh/20.jpg`
    },
    {
        id: "21",
        songName: `Sky Love<br>
        <div class="subtitle">Alan Walker</div>`,
        poster: `img/Arjit_Singh/21.jpg`
    },
    {
        id: "22",
        songName: `Alone<br>
        <div class="subtitle">Alan Walker</div>`,
        poster: `img/Arjit_Singh/22.jpg`
    },
    {
        id: "23",
        songName: `Faded<br>
        <div class="subtitle">Alan Walker</div>`,
        poster: `img/Arjit_Singh/23.jpg`
    },
    {
        id: "24",
        songName: `Hope<br>
        <div class="subtitle">Alan Walker</div>`,
        poster: `img/Arjit_Singh/24.jpg`
    },
...
const music = new Audio('audio/Arjit_Singh/11.mp3');
...
Array.from(document.getElementsByClassName('playListPlay')).forEach(element => {
    element.addEventListener('click', (el) => {
        ...
        music.src = `audio/Arjit_Singh/${index}.mp3`;
        poster_master_play.src = `img/Arjit_Singh/${index}.jpg`;
        music.play();
        ...
        download_music.href = `audio/Arjit_Singh/${index}.mp3`;
